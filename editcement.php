...
$qry = "SELECT * FROM `cementdetails` WHERE id=".$_REQUEST['id'];
...
<form action="edit-cementproces.php" method="post" onsubmit ="return val()">

<table border="0" cellspacing="10" cellpadding="5">
<h1 style="color:white">Edit Cement Information</h1>
