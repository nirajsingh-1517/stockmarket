...
$qry = "SELECT * FROM `telecomdetails` WHERE id=".$_REQUEST['id'];
...
<center>
<div style= "height:500px;width:500px;background-color:#d35537; margin:60px; padding:20px;border-radius:25px;margin-top:100px">
<form action="edit-telecomproces.php" method="post" onsubmit ="return val()">

<table border="0" cellspacing="10" cellpadding="5">
<h1 style="color:white">Edit Telecom Information</h1>
<input type="hidden" id="id" name="id" value="<?=$_REQUEST['id']?>">
<tr>
<td style="color:white;font-size:30px">Telecom Name:</td>
...
<tr>
<td style="color:white;font-size:30px">About Telecom:</td>
