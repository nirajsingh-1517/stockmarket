...
$qry = "SELECT * FROM `bankdetails` WHERE id=".$_REQUEST['id'];
...
<form action="edit-proces.php" method="post" onsubmit ="return val()">

<table border="0" cellspacing="10" cellpadding="5">
<h1 style="color:white">Edit Bank Information</h1>
