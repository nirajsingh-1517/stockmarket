...
$qry = "SELECT * FROM `golddetails` WHERE id=".$_REQUEST['id'];
...
<form action="edit-goldproces.php" method="post" onsubmit ="return val()">

<table border="0" cellspacing="10" cellpadding="5">
<h1 style="color:white">Edit Gold Information</h1>
<input type="hidden" id="id" name="id" value="<?=$_REQUEST['id']?>">
<tr>
<td style="color:white;font-size:30px">Gold Name:</td>
...
<tr>
<td style="color:white;font-size:30px">About Gold:</td>
